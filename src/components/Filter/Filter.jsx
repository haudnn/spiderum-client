      ...
      <div className="filter__wrapper">
        ...
        <div className="listtab">
          <div className="listtab__container">
            <Link to="/">
              <div className="listtab__wrapper">
                <p className="listtab__home-text">TRANG CHỦ</p>
                <div className="listtab__media">
                  <img
                    src="https://spiderum.com/assets/icons/singleLogo.png"
                    alt=""
                  />
                </div>
              </div>
            ...
            <Link to="/">
              <div className="listtab__wrapper">
                <p className="listtab__text">THỊNH HÀNH</p>
                <div className="listtab__media">
                  <i className="">
                    <svg
                      fill=" #718096"

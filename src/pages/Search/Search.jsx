          ...
          <div className="search__content-body">
            <div className="search__content-nav">
              <ul className="search__content-nav-menu">
                <li className="search__content-nav-item" onClick={() => navigate(`/search?q=${query}&type=post`)}>
                    <div className={`search__content-nav-item-wrapper ${type === 'post' ? "active" : ""}`}>
                ...
                <li className="search__content-nav-item" onClick={() => navigate(`/search?q=${query}&type=user`)} >
                    <div className={`search__content-nav-item-wrapper ${type === 'user' ? "active" : ""}`}>
                        <Link to="/" className="search__content-nav-link">
                            <i className="search__content-nav-icon bx bxs-user"></i>
                            <span className="search__content-nav-text">
                                Người dùng
                            </span>
                        </Link>
                    </div>
